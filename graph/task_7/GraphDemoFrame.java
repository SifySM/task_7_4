...
public class GraphDemoFrame extends JFrame {
    ...
    private JButton buttonFindCyclesWithoutForbVert;
    private JTextArea textAreaForbVert;
    ...
    public GraphDemoFrame() {
        ...
        buttonFindCyclesWithoutForbVert.addActionListener(e -> {
            String forbVert = textAreaForbVert.getText();
            TreeSet<Integer> treeForbVert = toVector(forbVert);
            ...
            try {
                ...
                Class clz = Class.forName("ru.vsu.cs.course1.graph." + className);
                Graph graph = GraphUtils.fromStr(textAreaGraphFile.getText(), clz);
                printToConsole(CycleFinder.findCycles(graph, treeForbVert));
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
        });
    ...
    private TreeSet toVector(String str) {
    ...
    private void printToConsole(Vector<Vector<Integer>> vector) {
        showSystemOut(() -> {
            boolean first = true;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        buttonFindCyclesWithoutForbVert = new JButton();
        buttonFindCyclesWithoutForbVert.setText("Search for cycles without forbidden vertices");
        panel7.add(buttonFindCyclesWithoutForbVert, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        textAreaForbVert = new JTextArea();
        textAreaForbVert.setText("");
        textAreaForbVert.setToolTipText("Запрещённые вершины");
        panel7.add(textAreaForbVert, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
